...
def ResNet10(num_c, use_norm=False):
  return ResNet(BasicBlock, [1,1,1,1], num_classes=num_c, use_norm=use_norm)
    
def ResNet18(num_c, use_norm=False):
    return ResNet(PreActBlock, [2,2,2,2], num_classes=num_c, use_norm=use_norm)
